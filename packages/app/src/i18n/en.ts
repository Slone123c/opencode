export const dict = {
  ...
  "context.breakdown.legacyTitle": "Conversation Breakdown",

  "context.sources.title": "Context Sources",
  "context.sources.instructions": "Instructions",
  ...
  "context.sources.groupRuntime": "Runtime",
  "context.sources.groupMcp": "MCP",
  "context.sources.groupSkillList": "Description",
  "context.sources.groupLoadedSkill": "Loaded",
  "context.sources.groupSupporting": "Supporting",
  "context.sources.skillShare": "{{percent}}% of Description",
  "context.sources.loadedShare": "{{percent}}% of Loaded",
  "context.sources.calls": "Calls {{count}}",
  "context.sources.items": "{{count}} items",
  "context.sources.summaryTop": "Top Source",
  "context.sources.summaryLoaded": "Loaded",
  "context.sources.summaryDescription": "Description",
  "context.sources.searchSkills": "Search skills...",
  "context.sources.sortAlpha": "A-Z",
  "context.sources.sortCalls": "Calls",
  "context.sources.sortPercent": "%",
  ...
  "settings.general.row.contextSources.title": "Show context sources",
  "settings.general.row.contextSources.description": "Display the detailed context source breakdown in the Context panel",
