...
export const dict = {
  ...
  "context.breakdown.legacyTitle": "对话分布",
  "context.sources.title": "上下文来源",
  "context.sources.instructions": "指令",
  ...
  "context.sources.groupRuntime": "运行时",
  "context.sources.groupMcp": "MCP",
  "context.sources.groupSkillList": "Description",
  "context.sources.groupLoadedSkill": "Loaded",
  "context.sources.groupSupporting": "辅助项",
  "context.sources.skillShare": "占 Description {{percent}}%",
  "context.sources.loadedShare": "占 Loaded {{percent}}%",
  "context.sources.calls": "调用 {{count}} 次",
  "context.sources.items": "{{count}} 项",
  "context.sources.summaryTop": "主要来源",
  "context.sources.summaryLoaded": "Loaded",
  "context.sources.summaryDescription": "Description",
  "context.sources.searchSkills": "搜索技能...",
  "context.sources.sortAlpha": "A-Z",
  "context.sources.sortCalls": "调用",
  ...
  "settings.general.row.contextSources.title": "显示上下文来源",
  "settings.general.row.contextSources.description": "在 Context 面板中显示详细的上下文来源拆分",
